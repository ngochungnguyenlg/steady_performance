...
For analysis data:
```
python python -i data -rlink "your revision/or result repo" dlink "your data link" --action "your action" --"range of data (file)"
```

For result analysis:

```
python python -i result -rlink "your revision/or result repo" dlink "your data link" --action "your action"
```
---
